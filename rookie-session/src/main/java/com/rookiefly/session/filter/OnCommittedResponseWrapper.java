...
abstract class OnCommittedResponseWrapper extends HttpServletResponseWrapper {
	...
	/**
	 * Invoke this method to disable invoking {@link OnCommittedResponseWrapper#onResponseCommitted()} when the {@link HttpServletResponse} is
	...
	/**
	 * Implement the logic for handling the {@link HttpServletResponse} being committed
	 */
